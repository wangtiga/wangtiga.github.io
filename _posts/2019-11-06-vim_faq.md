...
#### 如何在 vim-go 中用 Ctrl + ] 查看三方库，跳转到 vendor 目录中的代码，而非 $GOPATH/pkg/mod 目录的代码。[^vimgoGoToDefinationDebug]
...
[^vimgoGoToDefinationDebug]: [vimgoGoToDefinationDebug](https://wangtiga.github.io/2019/11/06/vim_faq.html#vimgoGoToDefinationDebug)
